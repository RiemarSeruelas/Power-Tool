...
Use an Admin password with at least 12 characters. Set `PUBLIC_APP_URL` to the address that other devices will use if QR codes must open the system from another computer or mobile device.
